               ...
               //  newElement.append(newChild);
                ...
                if (angular.isDefined(field.label)) {
                  ...
                  //  Everything else should be wrapped in a label tag.
                        ...
                        newElement.attr('ng-if', field.conditionExpression? field.conditionExpression : true);
                        var trElement = angular.element("<tr></tr>");
                         trElement.attr('ng-if', field.conditionExpression? field.conditionExpression : true);
                        var tdElementLabel = angular.element("<td></td>");
                        tdElementLabel.append(field.label);
                        var tdElementField = angular.element("<td></td>");

                        tdElementField.append(newElement);
                        trElement.append(tdElementLabel);
                        trElement.append(tdElementField);
                        tableElement.append(trElement);
                        console.log(tableElement);
                       // newElement.parent().append(tableElement);
                          //newElement = newElement.wrap("<label></label>").parent();
                         console.log(newElement);
                      //   newElement.prepend(document.createTextNode(field.label + ' '));
//                      //newElement = newElement.wrap("<tr></tr>").parent();
//                      console.log("tr=>"+newElement);
//                     // newElement = newElement.wrap("<td></td>").parent();
//                      console.log("td=>"+newElement);

                        masterTable = tableElement;
                ...
                if(field.type == 'accordion'){
                  ...
                  tableElement = angular.element("<table class='table table-bordered'></table>");;
